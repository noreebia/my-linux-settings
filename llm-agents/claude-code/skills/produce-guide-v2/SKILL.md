...
## Examples
    ...
    /produce-guide-v2
    /produce-guide-v2 --commit=abc1234
    /produce-guide-v2 --branch=feature/new-billing
    /produce-guide-v2 --lang=korean
    /produce-guide-v2 --branch=feature/new-billing --lang=japanese
